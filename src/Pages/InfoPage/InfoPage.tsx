...
const InfoPage = () => {
  ...
  const tabs = [
    ...
    { id: "about", label: "Blabla", ariaLabel: t("info.titles.about"), color: "#10B981" },
    { id: "site", label: "Site", ariaLabel: t("info.titles.site"), color: "#6366F1" },
    { id: "github", label: "Git", ariaLabel: t("info.titles.github"), color: "#6B7280" },
  ];
          ...
          <div className="bg-white rounded-lg shadow-md p-6 space-y-4">
            {(selectedTab === "all" || selectedTab === "about") && (
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6">
                ...
                <p className="text-gray-700">{t("info.description")}</p>
              </div>
            )}
